...
public class DoverCalais {
	...
	public void Before() throws Exception {
		...
		// web driver wait has to be initialised after the driver is created. DOH!
		...
		driver.get(baseURL);
		try {
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("buttonAccept")));
			...
			System.out.println("No Cookie Acceptance frame appeared. moving on!");
		}
